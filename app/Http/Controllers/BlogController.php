...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.blog.listBlog', $data);
    }
    ...
    public function store(Request $request, $id = false)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                if ($request->hasFile('image')) {
                    $imagePath = public_path(env('PATH_BLOG_IMAGE'));
                ...
                if ($request->hasFile('document')) {
                    $documentPath = public_path(env('PATH_BLOG_DOCUMENT'));
                ...
                return redirect('/blog/')->with('success_message', $message);
            }
        }
        ...
        return view('pages.blog.formBlog', $data);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($data->image) {
            $img_path = public_path(env('PATH_BLOG_IMAGE'));
            $img_old  = $data->image;
        ...
        if ($data->document) {
            $doc_path = public_path(env('PATH_BLOG_DOCUMENT'));
