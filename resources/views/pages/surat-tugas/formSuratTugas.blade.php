...
<div class="kt-portlet">
  ...
  <form class="kt-form kt-form--label-right" method="POST" action="{{ URL(setPostUrl()) }}">
    ...
    <div class="kt-portlet__body">
      ...
      <div class="form-group row">
          <label for="example-text-input" class="col-3 col-form-label">Pilih yang Menugaskan</label>       
              <div class="col-9">
      ...
      <div class="form-group row">
        <label for="example-text-input" class="col-3 col-form-label">Hari / Tanggal</label>
        <div class="col-9">
          <input class="form-control" type="text" name="tanggal" value="{{ @$list['tanggal'] }}" placeholder="Hari / Tanggal">
        </div>
      </div>

      <div class="form-group row">
        <label for="example-text-input" class="col-3 col-form-label">Waktu</label>
        <div class="col-9">
          <input class="form-control" type="text" name="waktu" value="{{ @$list['waktu'] }}" placeholder="Waktu">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-9">
          <textarea class="form-control" name="tempat" rows="3">{{ @$list['tempat'] }}</textarea>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-9">
          <textarea class="form-control" name="acara" rows="3">{{ @$list['acara'] }}</textarea>
        </div>
      </div>

      <div class="form-group row">
        <label for="example-text-input" class="col-3 col-form-label">Seragam</label>
        <div class="col-9">
          <input class="form-control" type="text" name="seragam" value="{{ @$list['seragam'] }}" placeholder="Seragam">
        </div>
      </div>
